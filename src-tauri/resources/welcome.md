...
LaTeX
: A typesetting system widely used for technical and scientific documents.
...
[^longnote]: Footnotes can contain **formatting**, `code`, and multiple paragraphs.
...
<sup>superscript</sup> and <sub>subscript</sub> via HTML.
